...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
		...
		//Connect to mysql server and selecting db
			...
			$resulta = mysqli_query($con,"SELECT sum(price) as value_sum FROM sales_order ") or die(mysqli_error($resulta));
			...
			$resulta = mysqli_query($con,"SELECT sum(price) as value_sum FROM products ORDER BY product_id DESC ") or die(mysqli_error($resulta));
			$row_sum = mysqli_fetch_assoc($resulta);
			$sum = $row_sum['value_sum'];
