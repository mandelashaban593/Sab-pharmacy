...
<a href="#" onclick="printPage('prodlist');" style="float:right;" class="btn btn-info"><i class="icon-print icon-large"></i> Medicine List</a>
			...
			<?php 
				...
				$result = $db->prepare("SELECT * FROM orders ORDER BY quantity DESC");
				$result->execute();
			...
			<?php 
				...
				$result = $db->prepare("SELECT * FROM orders where quantity < 10 ORDER BY product_id DESC");
				$result->execute();
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				$result = $db->prepare("SELECT *, price * quantity as total FROM orders ORDER BY med_name");
				$result->execute();
