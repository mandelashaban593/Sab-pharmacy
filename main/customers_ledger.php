...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			$resulta =  mysqli_query($con, "SELECT sum(qty) as value_sum FROM sales_order ") or die(mysqli_error($resulta));
			...
			$sum = $row_sum['value_sum'];
				...
				?></td>
			<td><?php 
			$resulta =  mysqli_query($con, "SELECT sum(qty*price) as value_sum FROM sales_order ORDER BY transaction_id DESC ") or die(mysqli_error($resulta));
			$row_sum = mysqli_fetch_assoc($resulta);
			$sum = $row_sum['value_sum'];
